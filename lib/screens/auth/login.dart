...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final heroHeight = (size.height * 0.38).clamp(220.0, 320.0);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          // ── FORM: fills remaining height, no background override
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                border: Border(
              ...
              padding: EdgeInsets.fromLTRB(20, 24, 20, padding.bottom + 12),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  // ── Email
